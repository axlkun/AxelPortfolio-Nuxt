<template>
    ...
    <v-sheet class="projects">
        <v-sheet class="container">
            <v-sheet class="title">
                <h1>Programación</h1>
                <p>Aquí puedes encontrar guías detalladas sobre la implementación de soluciones <br> en diferentes tecnologías como Java, Spring Boot, PHP, Laravel, Vue.js, Nuxt JavaScript y muchos más.
                </p>
            </v-sheet>
        </v-sheet>
...
const getArticles = async () => {
        try {
        const response = await api.get('/api/articles/filter?seccion=programacion');
...
title: 'Axel Cruz | Artículos de Programación',
author: 'Axel Cruz',
...
ogTitle: 'Axel Cruz | Artículos de Programación',
...
ogUrl: 'https://www.axelcruz.space/programación',
ogType: 'website',

twitterCreator: '@Axlkun',
twitterImage: 'https://www.axelcruz.space/og-image.png',
twitterCard: 'summary_large_image',
twitterTitle: 'Axel Cruz | Artículos de Programación',
